...
SELECT DISTINCT
  ...
  rpd.iIdUnidad,
  rpd.iIdUnidad as measureId,
  ins.CodigoInsumo as code,
  ins.NombreInsumo as name,
  ins.DescripcionInsumo supplyDescription,
  
  ROUND( IF( ins.iIdUnidad = u.iIdUnidad, ( rpd.Cantidad * ins.Calorias ), 
    IF( IsNull( con2.IdConversion ), 
    ( IF( con1.Operador = "Multiplicar", ( con1.Valor * ins.Calorias ), ( ins.Calorias / con1.Valor ) ) ),
    ( IF( con2.Operador = "Multiplicar", ( con2.Valor * ins.Calorias ), ( ins.Calorias / con2.Valor ) ) ) ) ), 2 )  as Calorias,
  
  ROUND( IF( ins.iIdUnidad = u.iIdUnidad, ( rpd.Cantidad * ins.Proteinas ), 
    IF( IsNull( con2.IdConversion ), 
    ( IF( con1.Operador = "Multiplicar", ( con1.Valor * ins.Proteinas ), ( ins.Proteinas / con1.Valor ) ) ),
    ( IF( con2.Operador = "Multiplicar", ( con2.Valor * ins.Proteinas ), ( ins.Proteinas / con2.Valor ) ) ) ) ), 2 )  as Proteinas,
  
  ROUND( IF( ins.iIdUnidad = u.iIdUnidad, ( rpd.Cantidad * ins.Grasas ), 
    IF( IsNull( con2.IdConversion ), 
    ( IF( con1.Operador = "Multiplicar", ( con1.Valor * ins.Grasas ), ( ins.Grasas / con1.Valor ) ) ),
    ( IF( con2.Operador = "Multiplicar", ( con2.Valor * ins.Grasas ), ( ins.Grasas / con2.Valor ) ) ) ) ), 2 )  as Grasas,
  
  ROUND( IF( ins.iIdUnidad = u.iIdUnidad, ( rpd.Cantidad * ins.HidratosCarbono ), 
    IF( IsNull( con2.IdConversion ), 
    ( IF( con1.Operador = "Multiplicar", ( con1.Valor * ins.HidratosCarbono ), ( ins.HidratosCarbono / con1.Valor ) ) ),
    ( IF( con2.Operador = "Multiplicar", ( con2.Valor * ins.HidratosCarbono ), ( ins.HidratosCarbono / con2.Valor ) ) ) ) ), 2 )  as HidratosCarbono,
